...
public class ResourceCentre {
	...
	public static void main(String[] args) {
		...
		Camcorder cc2 = new Camcorder("CC002", "Panasonic HC-MDH2", 10);
		Chromebook cc3 = new Chromebook("CB001", "ASUS Chromebook ", "Win 10");
		Chromebook cc4 = new Chromebook("CB002", "HP Chromebook", "Win 10");

		camcorderList.add(cc1);
		camcorderList.add(cc2);
		chromebookList.add(cc3);
		chromebookList.add(cc4);
